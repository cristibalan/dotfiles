...
set runtimepath=$HOME/.vim,$HOME/vimfiles,$HOME/.vim/evilchelu/fuf,$VIM/vimfiles,$VIMRUNTIME,$VIM/vimfiles/after,$HOME/.vim/after,$HOME/vimfiles/after
...
call KeyMap('n',  'CDLM', '\',       ':call FizzyReIndexCwd()<CR>')
...
call KeyMap('n',  '',    'TR',       '::tabnew<CR>:e ~/work/projects/office/days_cristi.txt<CR>')

nnoremap gb '[V']

" sql beautifier
" :%s/\(FROM\|LEFT\|RIGHT\|INNER\|WHERE\|GROUP\|ORDER\|LIMIT,\)/\r&
" :%s/\(AND\|,\)/&\r
